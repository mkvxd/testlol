...
export const REQUIRED_KEYS = [
    ...
    "k_evf_cv", "k_sysent_661", "k_jmp_rsi", "k_kl_lock",
];
...
PS4["9.03"] = Object.assign({}, PS4["9.00"], {
    alias_of: "9.00",
    fw_status: "state=PARTIAL alias_of=9.00 kernel=shared webkit=shared kpatch=missing-900.bin",
});
...
PS4["13.02"] = {
    fw_status: "state=13.02-only webkit=shared-with-13.00 kernel_rvas=corrected-from-scene-collective-1302.c kpatch=1302.bin bug=poops",
    wk_expm1_builtin:                   0x2586880,
    wk_JSFunction_m_function:           0x28,
    wk_POP_RDI_RET:                     0x5c480,
    wk_POP_RSI_RET:                     0x6e45e,
...
PS4["13.04"] = {
    ...
    wk___imp___error:                 0xDEAD0010,  
    k__error:                         0xDEAD0011,  
    wk___imp_pthread_create:          0xDEAD0012,  
    k_pthread_create:                 0xDEAD0013,  
